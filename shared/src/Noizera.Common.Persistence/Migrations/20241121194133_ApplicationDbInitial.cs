        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoverImageS3Folder = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OriginalS3Folder = table.Column<string>(type: "text", nullable: true),
                    MpegS3Folder = table.Column<string>(type: "text", nullable: true),
                    MpegContentLength = table.Column<long>(type: "bigint", nullable: true),
                    FlacS3Folder = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AlbumCredits_MusicSets_AlbumId",
                        column: x => x.AlbumId,
                        principalTable: "MusicSets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AlbumCredits_Profiles_ProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AlbumCredits_ProfileId",
                table: "AlbumCredits",
                column: "ProfileId");
