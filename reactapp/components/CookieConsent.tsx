...
export function CookieConsent() {
  ...
  return (
    <div className={`${hidden ? "hidden" : "block"} fixed bottom-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-sm p-4`}>
      <Card className="w-full border-t max-w-7xl mx-auto">
        <CardHeader>
