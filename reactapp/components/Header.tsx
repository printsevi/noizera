...
const Header: React.FC = () => {
  ...
  return (
    <header className={`flex w-full relative h-[70px] md:sticky md:top-0 items-center justify-between p-2.5 z-10 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 transition-all duration-300
    `}
    >
